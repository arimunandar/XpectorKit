...
// NSError domain
FOUNDATION_EXPORT NSString * const XP_PTProtocolErrorDomain;


@interface XP_PTProtocol : NSObject
...
@interface NSData (XP_PTProtocol)
...
@interface NSDictionary (XP_PTProtocol)
// See description of -[NSData(XP_PTProtocol) createReferencingDispatchData]
- (dispatch_data_t)createReferencingDispatchData;
